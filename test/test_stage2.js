...
exports.favicons = {
  ...
  manifestsum: function( test ) {
    ...
    var original = crypto
      .createHash( 'sha1' )
      .update( grunt.file.read( path + '/manifest.webapp' ))
      .digest( 'hex' );
    test.ok(
      original === '48a62081fee8bd4721f4b164bf8c5d36dd044d41',
      'firefox manifest hashsum not valid'
    );
    test.done();
  },
  ...
  htmlsum: function( test ) {
    ...
    var original = crypto
      .createHash( 'sha1' )
      .update( grunt.file.read( path + '/test.html' ))
      .digest( 'hex' );
    test.ok(
      original === '3de4a21225e96816a33312eb1172331257ac2837',
      'html hashsum not valid'
    );
    test.done();
  }
};
